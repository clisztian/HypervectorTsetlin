...
import hyperdimension.sequences.SparseSequenceEncoder;
import util.SparseHDViewer;
...
public class SparseTimeSeriesPrediction extends Application {
    ...
    private SparseSequenceEncoder encoder;
    Number val = 0;
    ...
    private final SparseHDViewer hdViewer = new SparseHDViewer();
    private final SparseHDViewer hdViewerInput = new SparseHDViewer();

    private List<SparseBinaryVector> latestBHVs = new ArrayList<>();
    private List<SparseBinaryVector> latestInputs = new ArrayList<>();
    ...
    public void trainTimeSeries(int model) {
        ...
        encoder = new SparseSequenceEncoder(data, quantization, nGrams);
    ...
    public void start(Stage stage) throws Exception {
        SparseTimeSeriesPrediction tsp = new SparseTimeSeriesPrediction();
        tsp.initiate(stage);
        stage.show();
    }
