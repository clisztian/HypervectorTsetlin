...
public class SparseHDViewer {
    ...
    public void setData(List<SparseBinaryVector> vanillaBHVS) {
        ...
        for(int i = 0; i < Math.min(NCOLS, size); i++) {
            SparseBinaryVector vanillaBHV = vanillaBHVS.get(size - i - 1);
    ...
    public int[] getBitArray(SparseBinaryVector vanillaBHV) {

        int[] vanillaBitArray = vanillaBHV.toBinaryArray();
        ...
        int chunkSize = vanillaBitArray.length / NROWS;
